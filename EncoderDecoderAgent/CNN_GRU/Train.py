...
class Train(BaseTrain):
    def __init__(self,
        ...
        self.encoder = Encoder(self.window_size, hidden_size, device, extension_size=data_train.state_size - 4)
        ...
        test_encoder = Encoder(self.window_size, hidden_size, device, extension_size=data_train.state_size - 4).to(device)
