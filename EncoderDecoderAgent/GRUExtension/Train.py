...
from EncoderDecoderAgent.GRUExtension.Seq2SeqModel import Seq2Seq
from EncoderDecoderAgent.GRUExtension.Decoder import Decoder
from EncoderDecoderAgent.GRUExtension.Encoder import EncoderRNN
from EncoderDecoderAgent.GRUExtension.Attention import AttentionLayer
...
class Train(BaseTrain):
    def __init__(self, data_loader,
        ...
        self.encoder = EncoderRNN(self.data_train.state_size, self.data_train.ext_size, self.hidden_size, device).to(device)
        ...
        test_encoder = EncoderRNN(self.data_train.state_size, self.data_train.ext_size, self.hidden_size, device).to(device)
